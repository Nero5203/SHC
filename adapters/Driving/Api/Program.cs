...
using adapters.Driven.ExternalServices.FileStorage;
...
builder.Services.AddScoped<IConfirmCheckoutPaymentUseCase, ConfirmCheckoutPaymentUseCase>();
...
builder.Services.AddHttpClient<IFileStorageRepository, RemoteFileStorageRepository>();
